...
public class MonsterDefinitionSO : ScriptableObject
{
    ...
    [Header("Traits")]
    private List<TraitDefinitionSO> _traits;
        ...
        List<SkillDefinitionSO> skills)
    {
        ...
        // Ensure we create new lists so we don't share memory references across assets
        ...
        // Tells Unity this asset has been modified and needs to be saved to disk
