...
public static class DamageCalculator
{
    ...
    /// </summary>
    public static int CalculateDamage(MonsterInstance caster, MonsterInstance target, float baseDamageValue, StatType scalingStat, float scalingCoefficient, MonsterElement attackElement)
    {
